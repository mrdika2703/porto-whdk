...
export default function Header() {
    ...
    return (
        <header
            className={`fixed top-4 left-1/2 z-50 flex w-[95vw] -translate-x-1/2 items-center justify-between gap-1.5 font-inter transition-all duration-500 ease-in-out md:top-6 md:w-max md:justify-center md:gap-4 ${
                isVisible
