...
export default function Form({ education }: FormProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        if (isEdit) {
            put(`/admin/education/${education.id}`, options);
        } else {
    ...
    return (
        <LayoutAdmin>
            <Head title={isEdit ? 'Edit Pendidikan' : 'Tambah Pendidikan'} />
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-tmuted">
                        {isEdit
                            ? 'Ubah informasi detail pendidikan Anda.'
                            : 'Tambahkan pendidikan baru ke dalam profil Anda.'}
                    </p>
                </div>
                <Link
                    ...
                    <div className="space-y-4 rounded-2xl border border-bmain/20 bg-bcard p-6 shadow-sm">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Deskripsikan jurusan, fokus studi, atau pencapaian Anda...&#10;&#10;Gunakan Enter untuk membuat paragraf baru."
                            />
                            <div className="mt-1 flex items-center justify-between">
                                {errors.description ? (
                                    <p className="text-xs text-red-500">
