...
class ProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'description_coding'   => 'nullable|string|max:5000',
            'description_multimedia'   => 'nullable|string|max:5000',
            'passion_coding'   => 'nullable|string|max:255',
            'passion_multimedia'   => 'nullable|string|max:255',
            'ttl'           => 'required|date',
            'photo'         => 'required|image|mimes:jpeg,png,jpg,webp|max:5128',
    ...
    public function update(Request $request, Profile $profile)
    {
        $validated = $request->validate([
            ...
            'passion_multimedia'   => 'nullable|string|max:255',
            'ttl'           => 'required|date',
            'photo'         => 'nullable|image|mimes:jpeg,png,jpg,webp|max:5128',
            'whatsapp'      => 'required|string|max:255',
            'email'         => 'required|email|max:255',
            'linkedin'      => 'required|string|max:255',
            'linkedin_name' => 'required|string|max:255',
